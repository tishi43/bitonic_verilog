...
HD_PWD='D:/tishi/bitonic_verilog/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitonic_sort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitonic_sort.tcl
