...
HD_PWD='D:/tishi/bitonic_verilog/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bitonic_sort.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bitonic_sort.tcl -notrace
